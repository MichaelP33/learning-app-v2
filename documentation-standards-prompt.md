...
Generate a complete article implementation for **Documentation Standards** including:
...
- **Article ID**: `documentation-standards` (from learning-content.json)
- **Article Name**: `Documentation Standards` (as it appears in data)
...
- [ ] Add `article.id === "documentation-standards"` to conditional rendering chain
- [ ] Create `DocumentationStandardsContent()` function with full implementation
