...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const proficiency = calculateOverallProficiency();
    setOverallProficiency(proficiency);
    setIsHydrated(true);
  }, []);
                ...
                <div className="relative w-32 h-20 mb-3">
                  ...
                  <svg className="w-full h-full" viewBox="0 0 128 72">
                    ...
                    <path
                      ...
                      strokeLinecap="round"
                      strokeDasharray={`${
                        ((isHydrated ? overallProficiency : 0) / 100) * 150.8
                      } 150.8`}
                  ...
                  <div className="absolute inset-0 flex items-end justify-center pb-1">
                    <span className="text-sm font-semibold text-white/90 drop-shadow">
                      {isHydrated ? `${overallProficiency}%` : "0%"}
                    </span>
                  </div>
                </div>
